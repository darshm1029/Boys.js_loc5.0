        ...
        <div className="h-screen w-full flex justify-center items-center bg-white">
          <section class="">
            <div class="py-8 px-4 mx-auto max-w-screen-xl  lg:px-6">
              ...
              <div class="grid grid-cols-2 gap-x-2 mx-auto">
                ...
                <div class="flex flex-col p-6 mx-auto  text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600  dark:bg-gray-900 dark:text-white">
                  ...
                  <a
                    href="#"
                    class="text-white bg-teal mx-auto hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900"
                  >
                    Get started
                  </a>
                </div>

                <div class="flex flex-col p-6 mx-auto  text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-dark dark:text-white">
                  ...
                  <a
                    href="#"
                    class="text-white bg-teal mx-auto text-lg hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900"
                  >
                    Get started
                  </a>
                </div>
